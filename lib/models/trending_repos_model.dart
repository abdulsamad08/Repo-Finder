...
TrendingRepos trendingReposFromJson(String str) =>
    TrendingRepos.fromJson(json.decode(str));

String trendingReposToJson(TrendingRepos data) => json.encode(data.toJson());
...
class TrendingRepos {
  ...
  factory TrendingRepos.fromJson(Map<String, dynamic> json) => TrendingRepos(
...
extension DefaultBranchExtension on DefaultBranch? {
  String? toJson() => defaultBranchValues.reverse[this ?? DefaultBranch.MAIN];
}
...
class Owner {
  ...
  factory Owner.fromJson(Map<String, dynamic> json) {
    return Owner(
      ...
      type: typeValues.fromString(json["type"]),
      userViewType: visibilityValues.fromString(json["user_view_type"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "user_view_type": userViewType != null
            ? visibilityValues.reverse[userViewType!]
            : null,
